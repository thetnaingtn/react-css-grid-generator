                ...
                <div id="code" ref={codeRef}>
                    {
                        showHtml ? (
                            <p>
                                &lt;
                                <AppCode.CName>div</AppCode.CName><AppCode.CProps> class="parent"</AppCode.CProps>&gt;<br />
                                {
                                    childArea.length > 0 ? (
                                        <span>
                                            {
                                                childArea.map((area, i) => (
                                                    <span key={area}>
                                                        <AppCode.Sp>
                                                            &lt;<AppCode.CName>div</AppCode.CName><AppCode.CProps>&nbsp;class="div{i + 1}"</AppCode.CProps>
                                            ...
                                            <span>
                                                {
                                                    childArea.map((area, i) => (
                                                        <span key={area}>
                                                            ...
                                                            <AppCode.CProps>{area}</AppCode.CProps>{"}"}<br />
                                                        </span>
                                                    ))
                                                }
                                            </span>

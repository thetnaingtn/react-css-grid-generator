...
export default function AppExplain(){
	return (
		<section>
			<p>You can set the numbers, and units of your columns and rows, and I'll generate a CSS grid for you! <strong>Drag within the boxes</strong> to create divs placed within the grid.</p>
			...
			<p>
				...
				<a href="https://twitter.com/rachelandrew" target="_blank">Rachel Andrew</a>,

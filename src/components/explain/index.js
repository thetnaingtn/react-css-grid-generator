  ...
  return (
    <section>
      ...
      <p>
        ...
        is not a comprehensive tour of CSS Grid capabilities. It is a way for
        you to use CSS Grid features quickly.
      </p>
      <p>
      ...
      <p>
        ...
        , and
        <a href="https://twitter.com/geddski" target="_blank" ref="noreferrer">
          Dave Geddes{" "}
        </a>
